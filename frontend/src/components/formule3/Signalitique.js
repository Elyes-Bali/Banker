    ...
    <>
      ...
      >
        ...
        <fieldset>
          ...
          <label htmlFor="street" className="input-text">
            {" "}
            Rue{" "}
          </label>
          <input
          ...
          <br />
          <br />
          <label htmlFor="city" className="input-text2">
            {" "}
            Ville{" "}
          </label>
          <input
          ...
          <label htmlFor="zip" className="input-text3">
            Code postal{" "}
          </label>
          <input
            className="input-holder form-control bordering"
        ...
        <div>
          <tr>
            <td>
              ...
              <br />
              <legend>
                <li> Nom et position du responsable/interlocuteur </li>
              </legend>
              <br />
              <br />
        ...
        <legend>
          <li>Secteur d'activité et descriptif du projet </li>
        </legend>
        <br />
