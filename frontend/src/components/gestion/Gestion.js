...
function Gestion() {
  ...
  return (
    <>
      <div className="shadow p-3 mb-5 bg-body rounded container" id="Gestion">
        ...
        <br />
        <label htmlFor="name">
          <li>Nombre de jours de travail par semaine: </li>
        </label>
        <input
          type="text"
          id="name"
        ...
        <div>
          ...
          <label htmlFor="name">Si oui Lesquelles </label>&nbsp;&nbsp;
          <input
            type="text"
            id="name"
